@include('lckamal/navigation::widgets.menu')
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="pull-right">
						<a class="btn btn-primary btn-xs" href="{{{resources('navigation.links/'.$group->id.'/create')}}}">Add Link</a> 
						<a class="btn btn-warning btn-xs" href="{{{resources('navigation.groups/'.$group->id.'/edit')}}}">Edit</a> 
						<a class="btn btn-danger btn-xs" href="{{{resources('navigation.groups/'.$group->id.'/delete')}}}">Delete</a> 
					</div>
